...
public class HomeResponse {
    ...
    // These are always computed from the actual database — never
    // hardcoded — so the numbers on the homepage genuinely grow as
    // real chefs, customers, and orders join the platform.
    private long totalApprovedChefs;
    private long totalCustomers;
    private long totalOrdersCompleted;
    private double averageChefRating;
    ...
    public long getTotalApprovedChefs() {
        return totalApprovedChefs;
    }

    public void setTotalApprovedChefs(long totalApprovedChefs) {
        this.totalApprovedChefs = totalApprovedChefs;
    }
    ...
    public double getAverageChefRating() {
        return averageChefRating;
    }

    public void setAverageChefRating(double averageChefRating) {
        this.averageChefRating = averageChefRating;
    }
}